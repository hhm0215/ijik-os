...
// Better Auth tables. The career data intentionally remains owner-wide while the
// product is single-user; user_id ownership is introduced with the SaaS/Postgres
