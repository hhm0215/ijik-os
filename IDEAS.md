...
- [open] (2026-07-14) **여유 작업 — 화면 구성·디자인 UX 점검**: 1.5단계 품질 안정화와
  로컬 실사용 흐름 검증을 우선 완료한 뒤, 카드 입력·공고 피드·분석 상세의 정보 위계,
  밀도, 상태 표현, 모바일 화면을 실제 사용 흐름 기준으로 리뷰한다. 예쁜 스타일 교체보다
  사용 중 발견한 혼란·불편을 먼저 해결한다.
