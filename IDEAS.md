...
- [open] (2026-07-14) `npm audit --omit=dev`에서 Next.js 내부 PostCSS 관련 moderate
  경고 2건. 현재 자동 수정은 Next 9.3.3으로의 깨지는 다운그레이드를 제안하므로 적용하지 않음.
  Next.js의 호환 가능한 패치 버전이 나오면 업데이트 후 재검증한다.
